...
def choose_model():
    ...
    model_weight = f'/home/lwc/python_script/ur_grasp/run_graspnet/process_utils/sam_b.pt'
    overrides = dict(
        task='segment',
        mode='predict',
        #imgsz=1024,
...
def detect_objects(image_or_path, target_class=None):
    ...
    """
    model = YOLO("/home/lwc/python_script/ur_grasp/run_graspnet/process_utils/yolov8s-world.pt")
    if target_class:
...
def segment_image(image_path, output_mask='mask1.png', target=None, is_input=True):
    """
...
if __name__ == '__main__':
    seg_mask = segment_image('/home/lwc/python_script/ur_grasp/run_graspnet/graspNet_data/color.png')
